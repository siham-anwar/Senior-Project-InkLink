...
import { previewStories } from "@/lib/mock-data";
          ...
          {previewStories.map((story, i) => (
            <FadeInView key={story.id} delay={i * 0.06}>
              <motion.article
                ...
                className="group flex h-full flex-col rounded-2xl border border-border bg-card p-5 shadow-sm"
              >
                ...
                <p className="mt-1 text-sm text-muted">by {story.author}</p>
